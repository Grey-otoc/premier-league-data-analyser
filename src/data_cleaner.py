...
PLAYER_DATA_DIR = CURRENT_DIR.parent.parent / "player_data"
...
def remove_unnecessary_columns():
    ...
    (fantasy points), bonus, bps (bonus points system), and selected_by_percent 
    (percent of FPL managers who selected that player)
    '''
    ...
    columns_to_drop = ["total_points", "bonus", "bps", "selected_by_percent"]
